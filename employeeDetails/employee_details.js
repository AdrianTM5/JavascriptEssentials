...
function findEmployeeBySpecialization() {
    const foundEmployeeS = employees.find(employee => employee.specialization === 'Javascript');
    if(foundEmployeeS) {
        document.getElementById('employeesDetails').innerHTML = `<p>${foundEmployeeS.id}: ${foundEmployeeS.name} - ${foundEmployeeS.department} - ${foundEmployeeS.specialization}</p>`;
    } else {
